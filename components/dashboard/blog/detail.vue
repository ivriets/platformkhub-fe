            ...
            <div class="grid grid-cols-12 gap-5">
                <div class="col-span-12 lg:col-span-4">
                    ...
                    <!-- <div class="mt-10 w-full bg-white shadow-md border border-gray-50 rounded-xl">
                        <img :src="basePath+dataDetail.imgMainImage" alt="main-image" class="rounded-[5px]">
                    ...
                    <div class="grid grid-cols-12 gap-5 mb-6">
                        ...
                        <div class="col-span-12 lg:col-span-6 text-sm font-semibold">
                            <div class="text-warna-delapan">Visibility</div>
                            <div class="text-warna-sembilan">
                                <div class="">{{ selectedFlag === 'indonesia' ? dataDetail.typeVisibility.nama[0] : dataDetail.typeVisibility.nama[1] }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-sm font-semibold mb-5">
                        <div class="text-warna-delapan">Issue</div>
