    ...
    methods: {
        ...
        simpan() {
            if (this.form.nama === '') {
                ...
                this.form.imgTestimoni = this.newImage && this.newImage.displayImage !== '' ? this.newImage.displayImage : this.form.imgTestimoni
                if (this.formMode == 'post') {
                    this.newVal.push(this.form);

                } else {
                    this.newVal[this.selectedIndex] = _.cloneDeep(this.form)
                }
        ...
        editItem(item,index) {
            ...
            this.newImage = {
                file: null,
                displayImage: this.form.imgTestimoni
            }
            this.modal.status = true
            this.$nextTick(() => {
                this.modal.key +=1
        ...
        displayImage(item) {
            if (item.imgTestimoni == '') {
                ...
                const source = item.imgTestimoni.substring(0,1) === '/' ? this.basePath + item.imgTestimoni : item.imgTestimoni;
