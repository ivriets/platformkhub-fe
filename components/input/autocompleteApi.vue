    ...
    <div v-click-outside="closeDropdown" class="w-full">
        ...
        <div class="relative w-full">
            <input 
                ...
                :id="name" 
                :ref="name"
                class="focus:outline-none w-full border border-warna-tujuh rounded-lg pl-2 pr-10 py-1.5 text-sm placeholder-[#9E9E9E] focus:border-warna-tujuh/50"
            ...
            <button v-if="newVal !== ''" @click="clearOpsi" class="absolute top-0 right-4 h-[34px] items-center flex px-2 text-gray-500">
